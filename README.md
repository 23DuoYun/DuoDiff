...
<table>
  <tr>
    <td align="center">
      <a href="examples/example1.mp4">
        <img src="examples/demo1.gif" width="420" />
      </a>
      <br><sub>Demo 1</sub>
    </td>
    <td align="center">
      <a href="examples/example3.mp4">
        <img src="examples/demo3.gif" width="420" />
      </a>
      <br><sub>Demo 2</sub>
    </td>
  </tr>
...
Please download [DL3DV](https://huggingface.co/datasets/DL3DV/DL3DV-Benchmark) following its official instructions, then organize it as:
